...
const ExamCreate = () => {
  ...
  return (
    <Box maxWidth={600} mx="auto" p={2}>
        <Typography variant="h5" align="center" gutterBottom>Create Exam</Typography>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Button type="submit" variant="contained" sx={{backgroundColor:"#0f0f0f"}}>Create Exam</Button>
        </form>
        ...
        {exams.length === 0 && !loading ? (
          ...
          <Box key={exam.id} p={2} mb={2} border="1px solid #ccc" borderRadius={2}>
            ...
            <Button variant="outlined" size="small"sx={{ mt: 1 }}onClick={() => navigate(`/exams/${exam.id}/questions`)}>
